...
HD_PWD='C:/Users/rkuba/Desktop/fpga_practice/clock/clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log show_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source show_clock.tcl
