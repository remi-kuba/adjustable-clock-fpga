...
HD_PWD='C:/Users/rkuba/Desktop/fpga_practice/clock/clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log show_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source show_clock.tcl -notrace
